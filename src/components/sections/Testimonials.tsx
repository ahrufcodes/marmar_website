...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      testimonial:
        "This project is very promising in pharmacy and it will benefit doctors and nurses too. Excellent application of technology, continue working on it.",
    ...
    {
      testimonial:
        "Managing multiple medications used to be a constant source of worry for me. With MarMar, I have found peace of mind. The personalized advice and clear information on medication interactions have made a significant difference in my daily life. It feels like having a personal healthcare assistant at my fingertips",
      author: "Lanre",
    ...
    {
      testimonial:
        "As a 4th year medical student, Marmar has been helpful and efficient in understanding pharmacology easier, especially in the aspect of drug-drug interactions and side effects of drugs. It is faster and also correlates with what I have in my lecture notes.",
      author: "Imran M",
